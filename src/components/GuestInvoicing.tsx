...
import type { GuestInvoice, SystemUser, GuestInvoiceStatus } from '@/lib/types'
...
export function GuestInvoicing({ currentUser }: GuestInvoicingProps) {
...
interface InvoiceListProps {
  ...
  getStatusIcon: (status: GuestInvoiceStatus) => JSX.Element
}
