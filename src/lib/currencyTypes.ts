export type CurrencyCode = 
  ...
  | 'SEK' | 'KRW' | 'NOK' | 'NZD' | 'INR' | 'LKR' | 'AED' | 'SAR' | 'QAR' | 'KWD'
  | 'BHD' | 'OMR' | 'JOD' | 'THB' | 'MYR' | 'IDR' | 'PHP' | 'BRL' | 'RUB' | 'ZAR'
...
export const CURRENCIES: Record<CurrencyCode, Currency> = {
  ...
  MXN: { code: 'MXN', name: 'Mexican Peso', symbol: '$', decimalPlaces: 2, symbolPosition: 'before', thousandsSeparator: ',', decimalSeparator: '.', isActive: true },
