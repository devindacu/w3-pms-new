...
/**
 * AI configuration settings per hotel.
 * Stores provider keys (encrypted at rest), models, feature flags, and usage limits.
 */
export const aiSettings = pgTable('ai_settings', {
  id: serial('id').primaryKey(),
  hotelId: varchar('hotel_id', { length: 100 }).default('default').notNull(),
  provider: varchar('provider', { length: 20 }).default('auto').notNull(),
  openaiApiKey: text('openai_api_key'),
  geminiApiKey: text('gemini_api_key'),
  openaiModel: varchar('openai_model', { length: 50 }).default('gpt-4o').notNull(),
  geminiModel: varchar('gemini_model', { length: 50 }).default('gemini-1.5-pro').notNull(),
...
/**
 * AI request/response logs for usage tracking and cost monitoring.
 */
...
/**
 * Demand forecasts generated by the AI forecasting engine.
 */
export const demandForecasts = pgTable('demand_forecasts', {
  ...
  predictedADR: decimal('predicted_adr', { precision: 10, scale: 2 }),
  predictedRevenue: decimal('predicted_revenue', { precision: 12, scale: 2 }),
  confidence: decimal('confidence', { precision: 5, scale: 2 }),
  demandLevel: varchar('demand_level', { length: 20 }).default('medium'),
...
export const aiInsights = pgTable('ai_insights', {
  ...
  potentialImpact: varchar('potential_impact', { length: 255 }),
